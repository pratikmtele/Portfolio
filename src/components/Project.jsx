function Project({
  ...
  return (
    <div className="project sm:w-[385px] bg-white border border-light-gray h-fit rounded-md overflow-hidden">
      <img
        src={coverImage}
        alt="Project 1"
      ...
      <div>
        ...
        <div className="my-4 mx-5 flex flex-wrap gap-2">
          {techs.map((tech) => (
            <div
              key={tech}
              className="w-fit text-sm flex items-center bg-gray-white py-1 px-2 border border-[#e3e3e3] rounded-md"
            >
              {tech}
            </div>
          ))}
